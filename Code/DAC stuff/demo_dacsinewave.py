...
run with: python demo_dacsinewave.py
================================================
...
#with gain set to 1, voltage output from the DAC goes from 0 - 2.048 V
#This loop creates a sine wave of 1.024V Amplitude from a 0 - 2.048 V.
